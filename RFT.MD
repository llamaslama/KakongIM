...
`Expected salary` : 60 \-70 W/ year

`Current salary` : 40W/ year
...
* 12 years of Internet industry development and management experience , worked for Yihaodian, Ali RT-Mart and other well-known Internet companies, have an intimate knowledge of Internet product development processes, familiar with JAVA highly concurrent technical and Jvm memory model ; 8 years of IOS / Android / React mobile terminal development and management, familiar with the development model and technology evolution of mobile products; 3 years of machine learning and Deep Learning Model , and data mining algorithms experience , familiar with Python / PyCharm and related development frameworks embodiment such as ( Pytorch , Keras , Sklearn , LSTM , BERT , Trans , Word2Vec , SVM , TextCNN , LR, etc.), participated in some e- commerce machine recommendation projects.
