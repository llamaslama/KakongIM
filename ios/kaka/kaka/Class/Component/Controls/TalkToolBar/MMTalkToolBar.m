...
static MMTalkToolBar * toolbar;

@implementation MMTalkToolBar

+(instancetype)newTalkToolBar:(id)owner
{
    if (! toolbar) {
        toolbar=[[[NSBundle mainBundle]loadNibNamed:@"MMTalkToolBar" owner:owner options:nil] objectAtIndex:0];
    }
    return toolbar;
}
...
-(void)didMoveToSuperview
{
    ...
    _picView=[[[NSBundle mainBundle]loadNibNamed:@"MMTalkToolBar" owner:self options:nil] lastObject];
