...
+ (void)showDlgAlert:(NSString *) label {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalStringForKey(@"alert") message:label delegate:self  cancelButtonTitle:NSLocalStringForKey(@"sure") otherButtonTitles:nil, nil];
