...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    ...
    if (imageScale>=viewScale) {
        image1=[MMImageUtil imageWithImageSimple:image1 scaledToSize:CGSizeMake(640, 640*imageScale)];
    }else{
        image1=[MMImageUtil imageWithImageSimple:image1 scaledToSize:CGSizeMake(bounds.size.height*2/imageScale, bounds.size.height*2)];
    }
    if (_callback) {
        _callback(image1);
    }
