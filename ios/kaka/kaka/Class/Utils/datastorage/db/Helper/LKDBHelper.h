...
-(void)rowCount:(Class)modelClass where:(id)where callback:(void(^)(NSUInteger rowCount))callback;
...
-(void)search:(Class)modelClass where:(id)where orderBy:(NSString*)orderBy offset:(NSUInteger)offset count:(NSUInteger)count callback:(void(^)(NSMutableArray* array))block;
