...
- (id)init
{
    return [self initWithDBName:@"KaKongIM"];
}
...
-(NSUInteger)rowCount:(Class)modelClass where:(id)where
{
    return [self rowCountBase:modelClass where:where];
}
-(void)rowCount:(Class)modelClass where:(id)where callback:(void (^)(NSUInteger))callback
{
    [self asyncBlock:^{
...
-(NSMutableArray *)search:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(NSUInteger)offset count:(NSUInteger)count
{
    return [self searchBase:modelClass where:where orderBy:orderBy offset:offset count:count groupby:nil];
}
-(id)searchSingle:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy
{
    NSMutableArray* array = [self searchBase:modelClass where:where orderBy:orderBy offset:0 count:1 groupby:nil];
...
-(void)search:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(NSUInteger)offset count:(NSUInteger)count callback:(void (^)(NSMutableArray *))block
{
    [self asyncBlock:^{
        NSMutableArray* array = [self searchBase:modelClass where:where orderBy:orderBy offset:offset count:count groupby:nil];
        
        if(block != nil)
            block(array);
    }];
}
-(void)search:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(NSUInteger)offset count:(NSUInteger)count groupby:(NSString*)groupby callback:(void (^)(NSMutableArray *))block
{
    [self asyncBlock:^{
        NSMutableArray* array = [self searchBase:modelClass where:where orderBy:orderBy offset:offset count:count groupby:groupby];
...
-(NSMutableArray *)searchBase:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(NSUInteger)offset count:(NSUInteger)count groupby:(NSString*)groupby
{
...
-(void)sqlString:(NSMutableString*)sql AddOder:(NSString*)orderby offset:(NSUInteger)offset count:(NSUInteger)count
{
    ...
    if(count>0)
    {
        [sql appendFormat:@" limit %lu offset %lu",(unsigned long)count,(unsigned long)offset];
    }
}
- (NSMutableArray *)executeResult:(FMResultSet *)set Class:(Class)modelClass
{
    ...
    LKModelInfos* infos = [modelClass getModelInfos];
    NSUInteger columeCount = [set columnCount];
    while ([set next]) {
